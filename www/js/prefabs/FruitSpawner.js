...
FruitNinja.FruitSpawner.prototype.create_object = function (name, position, velocity) {
    ...
    return new FruitNinja.Fruit(this.game_state, name, position, {texture: "fruits_spritesheet", group: "fruits", frames: this.frames, velocity: velocity}); // return fruit from spritesheet from given index with a velocity
};